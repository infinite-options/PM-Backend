    ...
    def get(self):
        ...
        with connect() as db:
            ...
            response['result']['revenue'] = list(
                response_revenue['result']) + list(response_rental_revenue['result']) + list(response_extra_revenue['result']) + list(response_late_fee_revenue['result'])
            response['result']['revenue_summary'] = list(
                response_revenue_summary['result']) + list(response_rental_revenue_summary['result']) + list(response_extra_revenue_summary['result']) + list(response_late_fee_revenue_summary['result'])
            response['result']['revenue_unit'] = list(
                response_revenue_unit['result']) + list(response_rental_revenue_unit['result']) + list(
                response_exta_revenue_unit['result']) + list(response_late_fee_revenue_unit['result'])
            # expense
